...
execute_process(
  COMMAND "/usr/bin/git" show-ref "OpenSSL_1_1_1-stable"
  WORKING_DIRECTORY "/home/koen/Documents/GitHub/micropython-cli/_deps/openssl-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "OpenSSL_1_1_1-stable")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("OpenSSL_1_1_1-stable" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/OpenSSL_1_1_1-stable")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/koen/Documents/GitHub/micropython-cli/_deps/openssl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/koen/Documents/GitHub/micropython-cli/_deps/openssl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
